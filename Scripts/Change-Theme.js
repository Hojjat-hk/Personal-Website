...
function changeThemeHandler(){
    ...
    if($.documentElement.classList.contains("dark-theme")){
        localStorage.setItem("Theme-HasDark", JSON.stringify(true));
        changeThemeButton.innerHTML = darkButtonIcon;
    }else{
        localStorage.setItem("Theme-HasDark", JSON.stringify(false));
        changeThemeButton.innerHTML = lightButtonIcon;
    }
}

// [+] Events
window.addEventListener("load", checkThemeHandler)
changeThemeButton.addEventListener("click", changeThemeHandler);